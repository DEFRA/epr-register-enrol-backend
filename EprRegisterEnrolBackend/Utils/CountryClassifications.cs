...
public static class CountryClassifications
{
    ...
    private static readonly HashSet<string> OecdCountries = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "Portugal", "Romania", "Slovakia", "Slovenia", "Spain", "Sweden",
        // Non-EU OECD
        "Australia", "Canada", "Chile", "Colombia", "Costa Rica", "Iceland", "Israel",
        "Japan", "South Korea", "Korea", "Mexico", "New Zealand", "Norway", "Switzerland",
        "Türkiye", "Turkey", "United Kingdom", "United States", "United States of America",
    };
