...
/// 85 (<c>IndexOptionsConflict</c>). This happens on deploy when an
/// environment already carries an older index definition that has since been
/// tightened. Left unhandled it breaks service startup, because
/// <c>EnsureIndexes</c> runs in the persistence constructor.
/// </para>
///
/// <para>
...
public static class MongoIndexReconciler
{
    ...
    ///   because the auto-derived name collides — e.g. <c>applicationReference_1</c>).</item>
    /// </list>
